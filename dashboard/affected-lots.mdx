---
title: "Affected lots — per-lot issue breakdown"
sidebarTitle: "Affected Lots"
description: "The affected lots table lists every production lot with at least one issue in the selected scope, showing issue count and comma-separated issue types per lot."
---
