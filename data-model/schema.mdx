...
sidebarTitle: "Schema"
description: "Overview of the SteelWorks PostgreSQL schema: 11 tables, 1 reporting view, foreign key relationships, check constraints, and the indexes that power dashboard queries."
---
...
The schema contains **11 tables** split across two categories:
