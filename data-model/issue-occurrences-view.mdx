...
description: "The issue_occurrences view pre-joins production_issues, production_runs, and issue_types as the single authoritative source for SteelWorks issue metrics."
---
