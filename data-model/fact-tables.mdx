...
description: "Documentation for SteelWorks transaction tables: production_runs captures daily output, production_issues records line issues per run, and shipments tracks order fulfillment."
---
