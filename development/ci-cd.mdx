---
title: "CI/CD pipeline for SteelWorks with GitHub Actions"
sidebarTitle: "CI/CD"
description: "How the SteelWorks GitHub Actions CI pipeline works — code quality checks with pre-commit and Docker image build validation on every pull request and push to main."
---
