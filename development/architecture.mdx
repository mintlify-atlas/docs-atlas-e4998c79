...
description: "How SteelWorks is structured: three-layer Python architecture with design decisions for the service layer, repository pattern, and in-memory fallback."
---
