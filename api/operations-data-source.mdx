...
description: "The OperationsDataSource Protocol defines the repository interface that OperationsMetricsService depends on, enabling custom data sources and test doubles."
---
